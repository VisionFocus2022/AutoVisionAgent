...
_EN_US: dict[str, str] = {
    ...
    "逐张即时": "Incremental",
    "并发数": "Concurrency",
    "整批模式生效：并行渲染/产物写（需引擎支持批量推理）": "Full-batch only: parallel post-processing (batch-infer engine required)",
    ...
    # W60：S_Tools 次批（SKolpha 复刻 FR-008）
    "裁剪数据集": "Crop Dataset",
    "修改尾缀": "Rename Suffix",
    "数据清洗": "Clean Dataset",
    "瓦片宽:": "Tile width:",
    "瓦片高:": "Tile height:",
    "旧后缀（如 .JPG）:": "Old suffix (e.g. .JPG):",
    "新后缀（如 .jpg）:": "New suffix (e.g. .jpg):",
    "清洗将把损坏图像与孤立标注移入 _trash 子目录（可恢复），确认执行？": "Clean moves corrupt images and orphan annotations into the _trash folder (recoverable). Proceed?",
    "图瓦片": "img tiles",
    "标注瓦片": "json tiles",
    "损坏": "corrupt",
    "孤立标注": "orphan json",
    "已隔离": "quarantined",
    "尾缀完成": "Rename Complete",
    "完成": "Done",
    "推理进行中": "Inference in progress",
    "请等待当前推理完成": "Please wait for the current inference to finish",
